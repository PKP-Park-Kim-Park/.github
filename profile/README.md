...
| 박상훈 | 클라이언트 / 서버 개발 / UI,UX / Design | `Unity`, `C#`, `C++` |
...
## ✅ 출시 완료
### 🎰 Greedy Machine - Steam 출시!
슬롯머신을 업그레이드 하고 강력한 보스를 처리하라!
간단한 룰로 보는 재미, 슬롯머신의 도파민을 선물합니다!

'슬롯머신' 프로젝트가 'Greedy machine'으로 Steam에 정식 출시되었습니다.
